...
[ -e simutrans/simutrans/music/TimGM6mb.sf2 ] || (download_with_retry https://sourceforge.net/p/mscore/code/HEAD/tree/trunk/mscore/share/sound/TimGM6mb.sf2?format=raw TimGM6mb.sf2 && cp ./TimGM6mb.sf2 simutrans/simutrans/music/TimGM6mb.sf2) || exit 1
...
[ -e simutrans/simutrans/get_pak.sh ] || cp src/android/unpak.sh simutrans/simutrans/get_pak.sh; chmod 755 simutrans/get_pak.sh  || exit 1
