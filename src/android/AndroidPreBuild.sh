...
[ -e ../simutrans/pak64.german ] || (download_with_retry https://simutrans-germany.com/pak.german/pak64.german_0-123-0-0-4_full.zip pak64.german_0-123-0-0-4_full.zip && unzip -n pak64.german_0-123-0-0-4_full.zip -d .) || exit 1
